...
CREATE TABLE IF NOT EXISTS t_sport_course_rating (
  ...
  CONSTRAINT fk_rating_course
    FOREIGN KEY (course_id) REFERENCES t_sport_course(id)
    ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS t_sport_course_audience (
  ...
  CONSTRAINT fk_ca_audience
    FOREIGN KEY (audience_id) REFERENCES t_sport_audience(id)
    ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS t_sport_course_equipment (
  ...
  CONSTRAINT fk_ce_equipment
    FOREIGN KEY (equipment_id) REFERENCES t_sport_equipment(id)
    ON DELETE RESTRICT,
...
CREATE TABLE IF NOT EXISTS t_sport_course_benefit (
  ...
  CONSTRAINT fk_cb_benefit
    FOREIGN KEY (benefit_id) REFERENCES t_sport_benefit(id)
    ON DELETE RESTRICT,
